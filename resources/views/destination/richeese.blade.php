...
<body>
 ...
 <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('{{ asset('landingpage/images/recheese3.jpg') }}');">
  <div class="overlay"></div>
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
       <p class="breadcrumbs"><span class="mr-2"><a href="{{route('index')}}">Home <i class="fa fa-chevron-right"></i></a></span> <span class="mr-2"><a href="{{route('destination')}}">Destination <i class="fa fa-chevron-right"></i></a></span> <span>Richeese Factory Jogja City Mall <i class="fa fa-chevron-right"></i></span></p>
       <h1 class="mb-0 bread">Richeese Factory Jogja City Mall</h1>
     </div>
   </div>
 </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 ftco-animate py-md-5 mt-md-5">
        <img src="{{ asset('landingpage/images/recheese1.jpg') }}" alt="" class="img-fluid">
      </div>
      <div class="col-lg-6 ftco-animate py-md-5 mt-md-5" style="text-align: justify;">
        <p>Recheese Factory di Jogja City Mall merupakan destinasi kuliner populer bagi para penggemar makanan cepat saji yang mengusung konsep keju sebagai bintang utamanya. Terletak di pusat perbelanjaan yang ramai, tempat ini menarik perhatian dengan menu ayam goreng krispy yang disiram saus keju yang melimpah dan lezat. Selain itu, Recheese Factory juga menawarkan berbagai level kepedasan, menambah sensasi dalam setiap gigitan. Interior restoran yang modern dan nyaman membuatnya menjadi tempat yang ideal untuk bersantap bersama teman atau keluarga. Dengan kombinasi rasa keju yang creamy dan bumbu pedas yang khas, Recheese Factory di Jogja City Mall berhasil menjadi favorit di kalangan anak muda dan keluarga di Yogyakarta.
            </p>
        </div>
        <div class="container">
        <div class="row">
          <div class="col-lg-6" style="text-align: justify;">
            ...
            <p>Beberapa menu yang tersedia di Richeese Factory Jogja City Mall antara lain:  </p>
            <ul>
              <li>Combo Big 4 : Rp 87.000</li>
              <li>Combo Big 8 : Rp 168.000</li>
              <li>Combo 2 Chicken : Rp 44.500</li>
              <li>Ala Carte : Rp 41.000</li>
              <li>Combo Duo Fire Chicken : Rp 53.000</li>
              <li>Pink Lava : Rp 10.000</li>
              <li>Frutarian : Rp 10.000</li>
              <li>Mineral Water : Rp 7.500</li>
          </div>
          <div class="col-lg-6">
            <h3 class="mb-3">Jam Buka</h3>
            <ul>
              <li>Setiap Hari, Pukul 10.00 – 22.00</li>
