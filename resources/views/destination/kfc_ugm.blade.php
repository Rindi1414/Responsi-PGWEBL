...
<body>
 ...
 <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('{{ asset('landingpage/images/kfc2.jpg') }}');">
  <div class="overlay"></div>
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
       <p class="breadcrumbs"><span class="mr-2"><a href="{{route('index')}}">Home <i class="fa fa-chevron-right"></i></a></span> <span class="mr-2"><a href="{{route('destination')}}">Destination <i class="fa fa-chevron-right"></i></a></span> <span>KFC UGM Yogyakarta <i class="fa fa-chevron-right"></i></span></p>
       <h1 class="mb-0 bread">KFC UGM Yogyakarta</h1>
     </div>
   </div>
 </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 ftco-animate py-md-5 mt-md-5">
        <img src="{{ asset('landingpage/images/kfc1.jpg') }}" alt="" class="img-fluid">
      </div>
      <div class="col-lg-6 ftco-animate py-md-5 mt-md-5" style="text-align: justify;">
        <p>KFC UGM Yogyakarta yang terletak di Terban, Sleman, Yogyakarta, adalah salah satu cabang restoran cepat saji terkenal yang selalu ramai oleh pengunjung, terutama mahasiswa dari Universitas Gadjah Mada dan masyarakat sekitar. Menawarkan menu ayam goreng khas KFC yang renyah dan lezat, restoran ini menjadi pilihan favorit untuk makan cepat dan praktis. Lokasinya yang strategis dekat kampus dan pusat kegiatan mahasiswa menjadikannya tempat yang ideal untuk bersantai, mengerjakan tugas, atau sekadar menikmati makanan enak bersama teman-teman. Dengan pelayanan yang cepat dan suasana yang nyaman, KFC UGM Yogyakarta berhasil mempertahankan popularitasnya sebagai salah satu destinasi kuliner terfavorit di kawasan tersebut.
            </p>
        </div>
        <div class="container">
        <div class="row">
          <div class="col-lg-6" style="text-align: justify;">
            ...
            <p>Beberapa menu yang tersedia di KFC UGM Yogyakarta antara lain:  </p>
            <ul>
              <li>Crispy Burger Combo : Rp 35.000</li>
              <li>Colonel Burger Combo : Rp 51.000</li>
              <li>Fish Burger Combo : Rp 51.000</li>
              <li>Kombo Super : Rp 60.000</li>
              <li>Winger Bucket : Rp 82.000</li>
          </div>
          <div class="col-lg-6">
            <h3 class="mb-3">Jam Buka</h3>
            <ul>
              <li>Setiap Hari, Pukul 10.00 – 21.00</li>
