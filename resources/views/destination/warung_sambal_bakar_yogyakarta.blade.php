...
<body>
 ...
 <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('{{ asset('landingpage/images/sambalbakar2.jpg') }}');">
  <div class="overlay"></div>
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
       <p class="breadcrumbs"><span class="mr-2"><a href="{{route('index')}}">Home <i class="fa fa-chevron-right"></i></a></span> <span class="mr-2"><a href="{{route('destination')}}">Destination <i class="fa fa-chevron-right"></i></a></span> <span>Warung Sambal Bakar <i class="fa fa-chevron-right"></i></span></p>
       <h1 class="mb-0 bread">Warung Sambal Bakar</h1>
     </div>
   </div>
 </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 ftco-animate py-md-5 mt-md-5">
        <img src="{{ asset('landingpage/images/sambalbakar3.jpg') }}" alt="" class="img-fluid">
      </div>
      <div class="col-lg-6 ftco-animate py-md-5 mt-md-5" style="text-align: justify;">
        <p>Warung Sambal Bakar Yogyakarta yang terletak di Kranggahan, Sleman, Yogyakarta, adalah surga bagi para pecinta sambal dengan berbagai macam jenis sambal yang menggugah selera. Tempat ini dikenal dengan sambalnya yang dibakar dengan sempurna, menghasilkan cita rasa yang khas dan aromatik. Setiap sambal memiliki karakteristik unik, mulai dari yang pedas menyengat hingga yang memiliki rasa gurih dan manis yang seimbang. Warung ini tidak hanya menawarkan sambal sebagai pelengkap, tetapi juga sebagai bintang utama dalam setiap hidangan, menjadikannya destinasi kuliner yang wajib dikunjungi bagi mereka yang ingin merasakan sensasi pedas yang autentik dan beragam di Yogyakarta.
            </p>
        </div>
        <div class="container">
        <div class="row">
          <div class="col-lg-6" style="text-align: justify;">
            ...
            <p>Beberapa menu yang tersedia di Warung Sambal Bakar antara lain:  </p>
            <ul>
              <li>Ayam Hemat : Rp 9.000</li>
              <li>Ayam Reguler : Rp 13.000</li>
              <li>Bebek : Rp 22.000</li>
              <li>Cumi : Rp 20.000</li>
              <li>Nila : Rp 15.000</li>
              <li>Es Teh : Rp 3.000</li>
              <li>Ice Lemon Tea : Rp 10.000</li>
              <li>Air Mineral : Rp 5.000</li>
              <li>Es Jerman : Rp 12.000</li>
          </div>
          <div class="col-lg-6">
            <h3 class="mb-3">Jam Buka</h3>
            <ul>
              <li>Setiap Hari, Pukul 11.00 – 21.30</li>
